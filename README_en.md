...
- **Optimization**: Software/hardware version player code, both add automatic rotation and scaling adaptation for portrait videos through filters.
- **Performance**: `HW_Audio_Video_Player.cpp` playing 4K high-bitrate video memory usage reduced from 800MB to 350MB.
- **Documentation**: Added Zhihu blog https://zhuanlan.zhihu.com/p/2013200050549958415 detailing the principles, workflow, and code application of hardware acceleration, as well as video rotation and scaling adaptation after integrating filter libraries.
